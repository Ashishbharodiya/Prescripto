...
function AddDoctor() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      Swal.fire({
        ...
        customClass: {
          confirmButton: 'bg-blue-600 text-white font-semibold py-2 px-4 rounded-md hover:bg-blue-700'
        }
      });
      ...
      Swal.fire({
        ...
        customClass: {
          confirmButton: 'bg-red-600 text-white font-semibold py-2 px-4 rounded-md hover:bg-red-700'
        }
      });
    }
  };
  ...
  return (
    <>
      <form onSubmit={handleSubmit} className="space-y-6 p-6 bg-gray-800 w-[1200px] shadow-md rounded-lg" autoComplete='off'>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 text-gray-100 hover:text-blue-400">
          ...
          {/* Gender, Degree, Experience, About */}
          <div className="space-y-4">
            {/* Gender */}
            <div>
